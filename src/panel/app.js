...
const GEAR = () =>
  html`<button class="btn btn-xs btn-ghost" id="wdp-desk-btn" data-testid="panel.desk-tuner" title="Settings"
    @click=${() => {
...
function renderGate() {
  ...
  if (S.picking && !S.project) {
    put(
      html`<div class="flex flex-1 items-center justify-center p-6 text-center text-[12.5px] opacity-50"
...
function syncProjectModal() {
  ...
  put(projectModal({ here, closable: projectModalClosable() }), D.projectModal);
}

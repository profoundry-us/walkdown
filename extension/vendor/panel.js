 ...
 * conversation looks like. Neither browser file can import, so this module is
 * the source and tools/sync-shared.mjs pastes it into both between markers.
 *
 ...
 */
const owedRows = () => orderedRows().filter(
...
const orderedRows = (rows) => groupedRows(rows)

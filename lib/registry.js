...
import { cacheDir } from './locations.js';

/** Where the cache sits: under cache/, the directory for what is derived and deletable (ADR 0003 §7). */
export const indexPath = () => join(cacheDir(), 'claims.json');

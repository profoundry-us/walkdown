 ...
 */
export function openThread(blueprint, { kind, body, anchor, via = null, reason = null, said: relayed = null, added = null }) {
  /*
...
export function transition(blueprint, id, { status, reason, via = null }) {
  ...
  return {
    thread: moveThread(blueprint, id, { status, actor, reason, via: via === 'agent' ? null : via }),
    by: who,
    as: actor,
  };
}

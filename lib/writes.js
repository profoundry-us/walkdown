...
export function openThread(blueprint, { kind, body, anchor, via = null, reason = null, said: relayed = null, added = null, options = null, asIs = false }) {
 ...
 */
export function reply(blueprint, id, { body, via = null, said = null, added = null, asIs = false }) {
  const who = whoIsActing(blueprint);
...
export function mutateThread(
  blueprint,
  id,
  { body = null, status = null, reason, via = null, said = null, added = null, asIs = false },
) {
  const who = whoIsActing(blueprint);

 ...
 */
export function writeRunRecord({ blueprintDir, target, baseUrl, actor, kind = 'checks', perTest, rulesById, date = new Date() }) {
  ...
  const record = {
    ...
    results: aggregateResults(perTest, rulesById),
  };

...
export function writeDraft(
  drafts,
  { target = 'local', actor, started, verdicts, threads = {}, signatures = null },
) {
  ...
  const draft = {
    ...
    /*
     * Who the sitting is being signed by, because this file is what a reload
     * restores FROM. Left out here, a walk declared as eng and product came
     * back from a reload as eng alone - and the record it later wrote said
     * one role where two were meant (n-0230). Absent stays absent: a draft
     * that never named signers is a sitting from before they existed.
     */

 ...
 */
const draftsDir = (blueprintDir) => resolveLocations({ dir: blueprintDir }).drafts.path;
 ...
 */
export function writeDraft(blueprintDir, { target = 'local', actor, started, verdicts, threads = {} }) {

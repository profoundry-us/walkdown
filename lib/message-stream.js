...
const MSG = {
  ...
  css: `
    ...
    .wd-text code { font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: .92em;
      padding: .05em .3em; border-radius: .25rem; background: color-mix(in oklch, currentColor 9%, transparent); }
    ...
    .wd-text pre code { padding: 0; background: none; font-size: .88em; }

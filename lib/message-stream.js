...
const MSG = {
  ...
  addition(added, { rules = [] } = {}) {
    ...
    return `<div class="wd-added" style="border-color:${this.tint('agent')}"><span class="wd-added-by" style="color:${this.tint('agent')}">${this.ROBOT} agent added</span>${this.body(added, { rules })}</div>`;
  },

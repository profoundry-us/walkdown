  ...
  function askCard(r, asked, open) {
    ...
    ${
      asked.options?.length
        ? b`<div class="mt-1.5 flex flex-col gap-1" data-testid="detail.ask-options">${asked.options.map(
      ...
      <div class="relative mt-2 mb-1.5 rounded border border-dashed px-2 pt-2.5 pb-1.5 text-[11px] leading-snug ${TURN[turn.party].line}"
        ...
        ${
          ...
          t.kind === 'question' && t.status === 'open'
            ? b`<div class="wd-stream mt-1.5 max-h-48 overflow-y-auto rounded bg-base-100/70 px-1.5 py-1" data-testid="thread.ask">${o$1(
